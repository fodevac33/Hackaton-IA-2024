...
const elevenLabsURL = "https://api.elevenlabs.io/v1/text-to-speech/FGY2WhTYpPnrIDTdsKH5";

export const processTextToSpeech = async (text: string): Promise<string | null> => {
  try {
